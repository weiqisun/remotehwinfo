...
- **-port** *(60000 = default)*
- **-hwinfo** *(0 = disable = default; 1 = enable)*
- **-gpuz** *(0 = disable = default; 1 = enable)*
- **-afterburner** *(0 = disable = default; 1 = enable)*
- **-log** *(0 = disable = default; 1 = enable)*
- **-help**
+ http<nolink>://ip:port/**json** *(UTF-8)*
	+ http<nolink>://ip:port/json?**enable=0,1,2,3** *(0,1,2,3 = entryIndex)*
	+ http<nolink>://ip:port/json?**disable=0,1,2,3** *(0,1,2,3 = entryIndex)*
